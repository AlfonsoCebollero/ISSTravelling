...
public class CreateFacturaServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		emailhandler.sendEmail(viaje.getAdvisor().getEmail(), "Subida de factura",
				"Se ha subido una factura relacionada al viaje con id " + advisor4 + " y destino " + viaje.getDestino()
						+ ".");
